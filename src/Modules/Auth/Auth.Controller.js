...
export const SignIn = async(req, res, next)=>{
    ...
    return res.status(200).json({message: "success", token, refreshToken  , id:user._id,role: user.role,name: user.userName, age: user.age, phone: user.phone, address: user.address});
}
