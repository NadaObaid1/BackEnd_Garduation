...
router.post('/increaseQuantity',auth(endPoint.get), CartController.increaseQuantity);
router.post('/decreaseQuantity',auth(endPoint.get), CartController.decreaseQuantity);
